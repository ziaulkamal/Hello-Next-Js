...
// Function to format and save data
async function formatAndSaveData(prompt) {
    try {
        // Generate results for each session with retry mechanism
        ...
        const result = {
            "session_1": formatSessionData(session1Response),
            "session_2": formatSessionData(session2Response),
            "session_3": formatSessionData(session3Response),
            "session_4": formatSessionData(session4Response),
            "session_5": formatSessionData(session5Response),
            "session_6": formatSessionData(session6Response),
            "session_7": formatSessionData(session7Response)
        };
